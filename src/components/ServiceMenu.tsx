      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {localSelected.length > 0 && (
          <motion.div
            ...
            className="mt-6 mx-auto max-w-2xl rounded-2xl border-2 border-amber-300 bg-white/95 p-4 shadow-xl shadow-amber-950/5 backdrop-blur-md flex flex-col sm:flex-row items-center justify-between gap-3"
          >
            <div>
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <button
                ...
                className="text-xs text-stone-500 hover:text-stone-800 px-2 py-1 font-medium"
              >
                Clear
              </button>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 sm:flex-initial flex items-center justify-center gap-2 rounded-xl bg-emerald-600 px-4 py-2 text-xs font-bold text-white shadow-md hover:bg-emerald-700 transition-colors"
              >
              ...
              return (
                <motion.div
                  ...
                  className={`group relative flex flex-col justify-between overflow-hidden rounded-2xl border transition-all duration-300 ${
                    isSelected
                      ? 'border-2 border-amber-500 bg-white shadow-xl shadow-amber-950/10'
                      : 'border border-stone-200/90 bg-white/95 hover:border-amber-300 hover:shadow-xl shadow-xs'
                  }`}
                >
                  {/* Card Content Top */}
                  <div>
